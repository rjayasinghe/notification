...
import static de.jayasinghe.samples.notification.dispatch.statemachine.OrderEvents.DELIVERED;
import static de.jayasinghe.samples.notification.dispatch.statemachine.OrderEvents.PLACED;
import static de.jayasinghe.samples.notification.dispatch.statemachine.OrderEvents.SHIPPED;
import static de.jayasinghe.samples.notification.dispatch.statemachine.OrderStates.COMPLETE;
import static de.jayasinghe.samples.notification.dispatch.statemachine.OrderStates.INITIAL;
import static de.jayasinghe.samples.notification.dispatch.statemachine.OrderStates.IN_PROCESS;
import static de.jayasinghe.samples.notification.dispatch.statemachine.OrderStates.ON_THE_ROAD;
...
public class OrderStateMachineConfig extends EnumStateMachineConfigurerAdapter<OrderStates, OrderEvents> {
    ...
    private final DeliveredAction deliveredAction;
    ...
    public OrderStateMachineConfig(PlacedAction placedAction, ShippedAction shippedAction,
        ...
        this.deliveredAction = deliveredAction;
    }

    @Override
    public void configure(StateMachineStateConfigurer<OrderStates, OrderEvents> states) throws Exception {
        states.withStates().initial(INITIAL).states(Set.of(IN_PROCESS, ON_THE_ROAD)).end(COMPLETE);
    }
